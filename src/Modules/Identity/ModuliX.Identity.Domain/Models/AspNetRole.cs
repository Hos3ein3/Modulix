...
public class AspNetRole : IdentityRole<Guid>, IBaseEntity<Guid>
{
    ...
    [NotMapped] public Guid? CreatedByUserId => throw new NotImplementedException();
    ...
    [NotMapped]
    public string? DeletedByUserId => throw new NotImplementedException();
